...
const sectionConfigs: Record<string, SectionConfig> = {
  company: {
    ...
    fields: [
      ...
      { name: 'officeBlurb_en', label: 'Office Blurb (English)', type: 'textarea' },
      { name: 'officeBlurb_mr', label: 'Office Blurb (Marathi)', type: 'textarea' },
      { name: 'reachTitle_en', label: 'Reach Form Title (English)' },
      { name: 'reachTitle_mr', label: 'Reach Form Title (Marathi)' },
      { name: 'reachSubtitle_en', label: 'Reach Form Subtitle (English)', type: 'textarea' },
      { name: 'reachSubtitle_mr', label: 'Reach Form Subtitle (Marathi)', type: 'textarea' },
      { name: 'primaryContact.name', label: 'Primary Contact Name' },
      { name: 'primaryContact.role', label: 'Primary Contact Role' },
      { name: 'primaryContact.phone', label: 'Primary Contact Phone' },
      { name: 'primaryContact.email', label: 'Primary Contact Email' },
      { name: 'primaryContact.photoUrl', label: 'Primary Contact Photo URL' },
      { name: 'secondaryContact.name', label: 'Secondary Contact Name' },
      { name: 'secondaryContact.role', label: 'Secondary Contact Role' },
      { name: 'secondaryContact.phone', label: 'Secondary Contact Phone' },
      { name: 'secondaryContact.email', label: 'Secondary Contact Email' },
      { name: 'secondaryContact.photoUrl', label: 'Secondary Contact Photo URL' },
    ],
  },
  services: {
